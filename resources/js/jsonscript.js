$(document).ready(function () {
    ...
    if ($("#categorieslist").length > 0) {
        ...
        $("#remove-category").click(function () {
            const remove_id = document
                .querySelector("#remove-category")
                .getAttribute("data-id");
            $.ajax({
                url: `categories/${remove_id}`,
                type: "DELETE",
                headers: {
    ...
    function loadCategories() {
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                if ($.fn.DataTable.isDataTable("#categorieslist")) {
                    $("#categorieslist").DataTable().destroy();
                }

                $(".datatable-length").empty();
                $(".datatable-paginate").empty();
                DataCategories(data);
            },
            error: function (xhr, status, error) {
                console.error("AJAX Error: " + status + " - " + error);
    ...
    function DataCategories(data) {
            ...
            columns: [
                {
                    render: function (data, type, row) {
                        ...
                        <input type="checkbox"><span class="checkmarks"></span></label>`;
                    },
                },
                {
                    render: function (data, type, row) {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="dropdown table-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item edit-popup" href="categories/${row["id"]}/edit">
                                    <i class="ti ti-edit text-blue"></i> Edit</a>
                                <a class="dropdown-item delete_items" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#delete_contact" data-id="${row["id"]}">
        ...
        const deleteBtns = document.querySelectorAll(".delete_items");
        deleteBtns.forEach((btn) => {
            btn.addEventListener("click", (event) => {
                const id = btn.getAttribute("data-id");
                const selected_model =
                    document.querySelector("#remove-category");
                selected_model.setAttribute("data-id", id);
            });
        });
    }
        ...
        $("#companieslist").DataTable({
            ...
            columns: [
                ...
                { data: "email" },
                {
                    render: function (data, type, row) {
                        if (row["status"] == "0") {
                            var class_name = "badge-success-light";
                            var status_name = "Collab";
                        }
                        if (row["status"] == "1") {
                            var class_name = "badge-warning-light";
                            var status_name = "Rated";
                        } else {
                            var class_name = "badge-purple-light";
                ...
                { data: "location" },
                {
                    render: function (data, type, row) {
                        return (
                            '<div class="set-star"><span><i class="fa fa-star filled"></i> ' +
                            row["rating"] +
                            " </span></div>"
                        );
                    },
        ...
        $("#leads_list").DataTable({
            ...
            columns: [
                ...
                },
                {
                    render: function (data, type, row) {
                        return (
                            '<a href="leads-details" class="title-name">' +
                            row["lead_name"] +
                            "</a>"
                        );
                    },
        ...
        $("#deal_list").DataTable({
            ...
            columns: [
                ...
                },
                {
                    render: function (data, type, row) {
                        return (
                            '<a href="deals-details" class="title-name">' +
                            row["Deal_Name"] +
                            "</a>"
                        );
                    },
                ...
                { data: "Deal_Value" },
                {
                    render: function (data, type, row) {
                        if (row["tag1"] == "Collab") {
                            ...
                            var class_name = "badge-danger-light";
        ...
        $("#testimonials_list").DataTable({
            ...
            data: [
                ...
                },
                {
                    ...
                    content:
                        "It have complete visiblity of clients & interactions",
                ...
                },
                {
                    ...
                    content:
                        "Most efficient process, accurate & consistent data",
            ...
            columns: [
...

                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="#" class="avatar"><img class="avatar-img" src="' +
                            row["customer_image"] +
        ...
        $("#customer-reporttable").DataTable({
            ...
            columns: [
                ...
                },
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="#" class="company-img"><img class="avatar-img" src="' +
                            row["customerreport_image"] +
                            '" alt="User Image"></a><a href="javascript:void(0);" class="profile-split d-flex flex-column">' +
                            row["customerreport_name"] +
                            "</a></h2>"
                        );
                    },
                },
            ...
            columns: [
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="project-details" class="company-img"><img class="avatar-img" src="' +
                            row["priority_img"] +
                            '" alt="User Image"></a><a href="project-details" class="profile-split d-flex flex-column">' +
                            row["priority_name"] +
                            "</a></h2>"
                        );
                    },
                ...
                },
                {
                    render: function (data, type, row) {
                        if (row["client"] == "1") {
                            var class_name = "bg-light-success";
                            var status_name = "Low";
                        }
                        if (row["client"] == "2") {
                            var class_name = "bg-light-warning";
                            var status_name = "Medium";
                        } else {
                            var class_name = "bg-light-danger";
                            var status_name = "High";
                        }
                        return (
                            '<span class="d-flex align-items-center badge badge-pill  ' +
                            class_name +
        ...
        $("#campaign-list").DataTable({
            ...
            columns: [
                ...
                { data: "type" },
                {
                    render: function (data, type, row) {
                        return (
                            '<ul class="list-progress"><li><h6>' +
                            row["open"] +
                            "</h6><p>Opened</p></li><li><h6>" +
                            row["close"] +
                            "</h6><p>Closed</p></li><li><h6>" +
                            row["unscubscribe"] +
                            "</h6><p>Unsubscribe</p></li><li><h6>" +
                            row["delivered"] +
                            "</h6><p>Delivered</p></li><li><h6>" +
                            row["converstion"] +
                            "</h6><p>Conversation</p></li></ul>"
                        );
                    },
                },
                {
                    render: function (data, type, row) {
                        return (
                            '<ul class="project-mem"><li><a href="#"><img src="' +
                            row["mem_image1"] +
                            '" alt="img"></a></li><li><a href="#"><img src="' +
                            row["mem_image2"] +
                            '" alt="img"></a></li><li><a href="#"><img src="' +
                            row["mem_image3"] +
                            '" alt="img"></a></li><li class="more-set"><a href="#">3+</a></li></ul>'
                        );
                    },
                },
                { data: "start_date" },
                { data: "end_date" },
                {
                    render: function (data, type, row) {
                        if (row["status"] == "0") {
                            var class_name = "success";
                            var status_name = "Success";
                        } else if (row["status"] == "1") {
                            var class_name = "warning";
                            var status_name = "Pending";
                        } else if (row["status"] == "2") {
                            var class_name = "danger";
                            var status_name = "Bounced";
                        } else if (row["status"] == "3") {
                            var class_name = "green";
                            var status_name = "Running";
                        } else {
                            var class_name = "info";
                            var status_name = "Paused";
                        }
                        return (
                            '<span class="badge badge-pill badge-status bg-' +
                            class_name +
                            '" >' +
                            status_name +
                            "</span>"
            ...
            columns: [
                ...
                },
                {
                    render: function (data, type, row) {
                        ...
                        return (
                            '<span class="priority badge badge-tag badge-' +
                            class_name +
                            '-light" ><i class="ti ti-square-rounded-filled"></i>' +
                            status_name +
                            "</span>"
                        );
                    },
                ...
                { data: "type" },
                {
                    render: function (data, type, row) {
                        if (row["stage"] == "0") {
                            ...
                            var class_name = "info";
                            var status_name = "Develop";
                        } else if (row["stage"] == "2") {
                            var class_name = "warning";
                            var status_name = "Design";
                        } else {
                            var class_name = "violet";
                            var status_name = "Plan";
                        }
                        return (
                            '<div class="pipeline-progress d-flex align-items-center"><div class="progress"><div class="progress-bar progress-bar-' +
                            class_name +
            ...
            columns: [
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="contact-details" class="avatar"><img class="avatar-img" src="' +
                            row["lead_img"] +
                            '" alt="User Image"></a><a href="contact-details" class="profile-split d-flex flex-column">' +
                            row["lead_name"] +
                            "<span>" +
                            row["lead_city"] +
                            " </span></a></h2>"
        ...
        $("#analytic-lead").DataTable({
            ...
            columns: [
                { data: "name" },
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="lead-details" class="company-img"><img class="avatar-img" src="' +
                            row["lead_img"] +
                            '" alt="User Image"></a><a href="lead-details" class="profile-split d-flex flex-column">' +
                            row["lead_name"] +
                            "<span>" +
                            row["lead_city"] +
                            " </span></a></h2>"
            ...
            columns: [
                ...
                { data: "title" },
                {
                    render: function (data, type, row) {
                        if (row["status"] == "0") {
                            var class_name = "bg-purple";
                            var status_name = "Meeting";
                            var icon_class_name = "user-share";
                        } else if (row["status"] == "1") {
                            var class_name = "bg-warning";
                            var status_name = "Email";
                            var icon_class_name = "mail";
                        } else if (row["status"] == "2") {
                            var class_name = "bg-blue";
                            var status_name = "Task";
                            var icon_class_name = "subtask";
                        } else {
                            var class_name = "bg-green";
                            var status_name = "Calls";
                            var icon_class_name = "phone";
                        }
                        return (
            ...
            columns: [
                ...
                { data: "code" },
                {
                    render: function (data, type, row) {
                        ...
                        return (
                            '<div class="status-toggle"><input type="checkbox" id="' +
                            row["language"] +
                            '" class="check" ' +
                            attr_name +
                            '><label for="' +
                            row["language"] +
                            '" class="checktoggle">/label></div>'
                        );
                    },
                },
                { data: "total" },
        ...
        $("#manage-users-list").DataTable({
            ...
            columns: [
                ...
                },
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="javascript:void(0);" class="avatar"><img class="avatar-img" src="' +
                            row["customer_image"] +
                            '" alt="User Image"></a><a href="javascript:void(0);" class="profile-split d-flex flex-column">' +
                            row["customer_name"] +
                            " <span>" +
                ...
                { data: "subject" },
                {
                    render: function (data, type, row) {
                        return (
                            '<h2 class="table-avatar d-flex align-items-center"><a href="#" class="avatar"><img class="avatar-img" src="' +
                            row["assigned_image"] +
                            '" alt="User Image"></a><a href="#" class="profile-split d-flex flex-column">' +
                            row["assigned_name"] +
                            "</span></a></h2>"
                        );
                    },
                ...
                { data: "country_code" },
                {
                    render: function (data, type, row) {
                        return (
                            ...
                            '<span class="location-flag-img"><img src="' +
                            row["country_image"] +
