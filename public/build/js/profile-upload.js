...
$(".input-img").on("change", function () {
    var elecontrol = $(this).attr("data-imgpreview");
    var imgControlName = $(`.${elecontrol}`);
    if (imgControlName == undefined) {
        var imgControlName = ".preview1";
    }
    readURL(this, imgControlName);
    $(this).closest(".profile-upload").find(".preview1").addClass("it");
    $(this)
        .closest(".profile-upload")
        .find(".profile-remove")
        .addClass("profile-remove-btn");
});
$(".profile-remove").on("click", function (e) {
    ...
    $(this)
        .closest(".profile-upload")
        .find(".profile-remove")
        .removeClass("profile-remove-btn");
});
